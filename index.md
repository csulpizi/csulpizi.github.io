...
|[<img width="300px" src="images/menu_icon_k_means.gif?raw=true"/>](https://github.com/csulpizi/Python-K-Means-Classifier)|[Repository](https://github.com/csulpizi/Python-K-Means-Classifier)<p>A Python classifier that uses k-means clustering in up to N dimensions to define the decision boundary for each class.</p>|
|[<img width="300px" src="images/menu_java_publications.png"/>](https://github.com/csulpizi/publications)|[Repository](https://github.com/csulpizi/publications)<p>A lightweight Java class for broadcasting messages and triggering events synchronously.</p>|
